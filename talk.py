...
class CommandLine:
    ...
    def _print_info(self):
        ...
        print("\t[system <talker> misses]   Returns the number of misses per socket, bad checksum transfers.")
        print("\t[system <talker> drops]    Returns the number of drops associated to out of time messages.")
        print("\t[system <talker> fails]    Returns the number of fails associated to failed to send messages.")
